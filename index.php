...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:@gmail.com">WTL@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+9988775511</li>
			<!--	 <li class="s-bar">
						<div class="search">
				   ...
				   <div class="ab-w3l-spa">
						   ...
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>To keep a customer demands as much skill as to win one. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/teams2.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/teams3.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/teams1.jpg" alt=" " class="img-responsive" />
					</li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+9988775511</p>
			<p class="contact-agile1"><strong>Email :</strong>WTL@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Mysuru,Karnataka</p>
			...
			<iframe src="https://www.google.com/maps/embed?data=!3m1!4b1!4m5!3m4!1s0x3baf7a5fd7f84b71:0x56edd06e7a72a40!8m2!3d12.336565!4d76.618745" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2017 HOTEL SITE . All Rights Reserved | Brought To You by WT </p>
		    </div>
<!--/footer -->
<!-- js -->
